...
static CGFloat const kAwesomeMenuDefaultAddRotation = -M_PI_4;
...
@synthesize nearRadius, endRadius, farRadius, timeOffset, rotateAngle, menuWholeAngle, startPoint, expandRotation, closeRotation, animationDuration, rotateAddButton, addRotation;
...
- (id)initWithFrame:(CGRect)frame startItem:(AwesomeMenuItem*)startItem menuItems:(NSArray *)menuItems
{
    ...
    if (self) {
        ...
        self.addRotation = kAwesomeMenuDefaultAddRotation;
